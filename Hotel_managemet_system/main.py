"""
AIM : to simplify hotel operations by automating them
The major aspects of hotel management; it could perform the following operations :
(1) Hotel Booking
(2) Provide you with Hotel Rooms Info
(3) Room Service
